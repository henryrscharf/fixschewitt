...
1. Presentation slides: \url{http://goo.gl/wmX6Xd} <!-- Henry's site -->
2. Virtual machine used to run R/Hadoop for the lab (requires ~4GB RAM): \url{http://goo.gl/R5Okcr}  <!-- Dropbox -->
3. Lab instructions: \url{http://goo.gl/z5BLaZ} <!-- Henry's site -->
4. Lab R script: \url{http://goo.gl/dBaxrq} <!-- Henry's site -->
